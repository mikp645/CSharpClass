...
namespace CSharpClass.Lessons
{
    ...
    /*
    The shift left operator will take the value as an primitive type and
    convert it to the binary version binary is grouped in 4's, so it will
    shift the binary version of the number to the left by the number of
    spaces. The high-order bits outside the range of the result type of x
    are discarded, the remaining bits are shifted left, and the low-order
    empty bit positions are set to zero .
        */
         ...
         */
         ...
         /*
         This Or bitwise compares the binary of both numners. Only 1 of
         ...
         public void MyOrAssignmentOperator()
         {
            ...
            value |= value2;  // answer is 0001 1111 31
            Console.WriteLine(value);
